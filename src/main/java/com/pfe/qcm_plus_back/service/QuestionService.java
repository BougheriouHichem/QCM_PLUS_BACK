...
public class QuestionService {
    ...
    public Question updateQuestion(Long id, Question questionDetails) {
        return questionRepository.findById(id)
                .map(question -> {
                    ...
                    question.setChoix(questionDetails.getChoix()); // Mise à jour du tableau de réponses
    ...
    // Méthode pour modifier l'appartenance d'une question à un autre questionnaire
